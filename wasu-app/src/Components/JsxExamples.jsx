...
function JSXExamples() {
    ...
    const user = {
    firstName: "Wasu",
    lastName: "Sakulphuttachote",
    age: 20,
    hobbies: ["นอนเล่น", "เล่นเกม", "ฟังเพลง","ดูหนัง"]
  };
        ...
        <div className="jsx-examples">
            ...
            <section>
                ...
                <div className="product-list">
                    <h3>รายการสินค้า</h3>
                    {[
                        { id: 1, name: 'เสื้อฟุตบอล Manchester United', price: 2900, inStock: true },
                        { id: 2, name: 'เสื้อฟุตบอล Liverpool', price: 2900, inStock: true },
                        { id: 3, name: 'เสื้อฟุตบอลทีมชาติไทย', price: 1290, inStock: false }
